...
Let's look at `table2`. Here, the names of two variables are included in the type column and the corresponding values are in the `count` column. There are two rows per observation. Pivot

```{r}
table2
```
To tidy this, we meed to let R know 3 things: 
